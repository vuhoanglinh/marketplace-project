      ...
      <div class="span12">
        <div class="box box-color box-bordered green">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('stores/product/updateProduct', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            <div class="control-group">
              <label for="txtName" class="control-label">Tên</label>
                <div class="controls">
                  <input type="text" name="txtName" id="txtName" placeholder="Tên sản phẩm (*)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtName', $name); ?>">                  
                </div>                
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <label for="txtAmount" class="control-label">Số lượng</label>
                <div class="controls">
                  <input type="text" name="txtAmount" id="txtAmount" placeholder="Số lượng sản phẩm (Nhập số)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtAmount', $amount); ?>">                  
                </div>                
            </div>
            <div class="control-group">
              <label for="txtPrice" class="control-label">Giá</label>
                <div class="controls">
                  <input type="text" name="txtPrice" id="txtPrice" placeholder="Giá sản phẩm (Nhập số)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtPrice', $price); ?>">                  
                </div>                
            </div>
            <div class="control-group">
              <label for="txtNewPrice" class="control-label">Giá khuyến mãi</label>
                <div class="controls">
                  <input type="text" name="txtNewPrice" id="txtNewPrice" placeholder="Giá khuyến mãi (Nhập số)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtNewPrice', $s_price); ?>">                  
                </div>
            </div>
             <div class="control-group">
              <label for="txtType" class="control-label">Nhãn</label>
                <div class="controls">
                  <label class="radio">
                        <input type="radio" name="rdType" <?php echo ($type == 0) ? 'checked="checked"' : ''; ?> value="0"> Không có nhãn
                  </label> 
                  <label class="radio">
                        <input type="radio" name="rdType" <?php echo ($type == 1) ? 'checked="checked"' : ''; ?> value="1"> Nhãn mới
                  </label> 
                  <label class="radio">
                        <input type="radio" name="rdType" <?php echo ($type == 2) ? 'checked="checked"' : ''; ?> value="2"> Nhãn hot
                  </label>                
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <label for="txtDetail" class="control-label">Mô tả</label>
                <div class="controls">
                  <textarea name="txtDetail" id="txtDetail" rows="5" class="input-block-level" placeholder="Mô tả ngắn" maxlength="255"><?php echo set_value('txtDetail', $detail); ?></textarea>                
                </div>
            </div>
            <div class="control-group">
              <label for="txtContent" class="control-label">Bài viết</label>
                <div class="controls">
                  <textarea name="txtContent" id="txtContent" rows="5" class="input-block-level"><?php echo set_value('txtContent', $content); ?></textarea>                
                </div>
            </div>      
            <div class="control-group">
