  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url();?>stores/product/addimages?id=<?php echo $id; ?>">Thêm hình</a></li>
      </ul>
      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('stores/product/addimages', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
