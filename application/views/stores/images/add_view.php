      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('stores/images/addImages', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            ...
            <div class="control-group">
              <label for="txtThumb" class="control-label">Thumb</label>
                <div class="controls">
                  <input type="text" name="txtThumb" id="txtThumb" placeholder="Đường dẫn hình ảnh" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtThumb', ''); ?>">                  
