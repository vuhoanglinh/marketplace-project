  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url(); ?>stores/event/trash">Thùng rác</a></li>
      </ul>
        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>stores/event/trash?key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"> <?php echo form_open("stores/event/delete", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){  
                ...
                function loadevent(page) {
                  $.ajax({
                      url: "<?php echo base_url('stores/event/pagging_trash'); ?>",
                      type: "post",
                    ...
                    $("input[type=checkbox]").each(function() { 
                      if($(this).attr("id") != "check_all") 
                      {
                        if($(this).is(":checked"))
                        {
                          ...
                          $.ajax({
                              url: "<?php echo base_url(); ?>stores/event/outtrash",
                              type: "POST",
                              dataType: "json",
                              data: 'id=' + $(this).val(),
                              beforeSend : function (){
