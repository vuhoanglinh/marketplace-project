      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('stores/category/addCategory', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            ...
            $(document).ready(function(){ 
              ...
              function checkname()
              {
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>stores/category/checkname",
              ...
              function checkTitle()
              {
                ...
                if(title == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>stores/category/checktitle",
