  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url('stores/category/children');?>?id=<?php echo $id_parent ?>"><?php echo $name_parent; ?></a> <i class="icon-angle-right"></i></li>
        <li> <a href="<?php echo base_url('stores/category/trashchild');?>?id=<?php echo $id_parent ?>">Đã xóa</a> </li>
      </ul>
        ...
        <div class="box box-color box-bordered lightred">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>stores/category/trashchild?id=<?php echo $id_parent; ?>&key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"><?php echo form_open("stores/category/delete", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){
                function loadcategory(page) {
                  $.ajax({
                      url: "<?php echo base_url('stores/category/paggingtrashchild'); ?>",
                      type: "post",
                      ...
                      if($(this).attr("id") != "check_all") 
                      {
                        if($(this).is(":checked"))
                        {
                          var from = $('form#frmtrash');
                            $.ajax({
                                url: "<?php echo base_url('stores/category/outtrash'); ?>",
                                type: "post",
                                dataType: 'json',
                                data: 'id=' + $(this).val(),
                                success: function(data) {
