                  ...
                  <tr>
                    ...
                    <td class="hidden-480">
                      ...
                      <a href="<?php echo base_url('stores/category/children'); ?>?id=<?php echo $row->id;?>" class="btn" rel="tooltip" title="Danh mục con"><i class="icon-list-alt"></i></a>
                    </td>
                  </tr>
                  ...
                  $(document).ready(function(){
                    $("form#frmtrash a").click(function(){
                      ...
                      {
                        var url = '<?php echo base_url(); ?>stores/category/update?id='+a.attr('dataid');
                      ...
                      {                    
                          $.ajax({
                              url: '<?php echo base_url(); ?>stores/category/block',
                              type: "POST",
                              dataType: 'json',
                      ...
                      {
                        $.ajax({
                          url : "<?php echo base_url(); ?>stores/category/status",
                          type : "POST",
                          dataType : "json",
