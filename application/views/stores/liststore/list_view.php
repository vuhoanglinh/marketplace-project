        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>stores/liststore?key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"> <?php echo form_open("stores/liststore/movetrash", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            <div class="dataTables_wrapper">     
              ...
              <div class="dataTables_length">
                ...
                <a href="<?php echo base_url(); ?>stores/liststore/add" action="add" class="btn btn-primary">
                  <i class="icon-plus"></i> Thêm mới</a>
                <a href="<?php echo base_url(); ?>stores/liststore/trash" class="btn btn-inverse"><i class="icon-trash"></i> Đã xóa</a>
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){  
                ...
                function loadevent(page) {
                  $.ajax({
                      url: "<?php echo base_url('stores/liststore/pagging_list'); ?>",
                      type: "post",
