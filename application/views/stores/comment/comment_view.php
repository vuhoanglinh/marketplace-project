  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url('stores/comment'); ?>">Liên hệ</a> </li>        
      </ul>
    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="box box-color box-bordered">
          <div class="box-title">
            <h3> <i class="icon-envelope"></i> <?php echo $titlepage; ?></h3>
          </div>
...
$(document).ready(function(){
  ...
  {
    $.ajax({
      url: "<?php echo base_url('stores/comment/paggingtimeline'); ?>",
      type: "post",
