  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url('stores/themes'); ?>">Thư viện template</a> </li>        
      </ul>
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  ...
                  var url = '<?php echo base_url(); ?>stores/themes?key='+key;
...
$(document).ready(function(){
  ...
  {
    $.ajax({
      url: "<?php echo base_url('stores/themes/pagging_list'); ?>",
      type: "post",
      data: "id_store="+ id+ "&page="+page+"<?php echo ($key != "")? '&key='.$key : ''; ?>",
