  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url('adminlevel/slideshow'); ?>">Thư viện slideshow</a> </li>
      </ul>
        ...
        <div class="box">
          ...
          <div class="box-content nopadding">
            <div class="highlight-toolbar">
              ...
              <div class="pull-right">
                <div class="btn-toolbar">
                  <div class="btn-group">
                    <a href="<?php echo base_url('adminlevel/slideshow/add');?>" class="btn btn-danger" rel="tooltip" title="Upload hình ảnh"><i class="icon-cloud-upload"></i> Upload hình ảnh</a>                      
                  </div>
                </div>
              </div>
            </div>
            ...
            <ul class="gallery">
              ...
              ?>
              <li> <a href="#"> <img width="350" style="width:350px;" src="<?php echo ($row->image != "") ? $row->image : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image';; ?>" alt=""> </a>
                <div class="extras" <?php echo ($row->status == 0) ? 'style="display:block;"' : ''; ?>>
                  <div class="extras-inner"> <a href="<?php echo $row->image; ?>" class='colorbox-image' rel="group-1"><i class="icon-search"></i></a> <a href="<?php echo base_url('adminlevel/slideshow/update'); ?>?id=<?php echo $row->id;?>"><i class="icon-pencil"></i></a> <a href="javascript:void(0)" dataid="<?php echo $row->id; ?>" data="<?php echo ($row->status == 0?'1':'0'); ?>" class='update-gallery-pic'><i class="<?php echo ($row->status == 1) ?  'icon-eye-open' : 'icon-eye-close'; ?>"></i></a> <a href="#" class='del-gallery-pic' dataid="<?php echo $row->id; ?>" data="<?php echo ($row->statuscp == 0?'1':'0'); ?>"><i class="icon-trash"></i></a> </div>
                </div>
              </li>
              <?php }?>
            </ul>
              ...
              $(document).ready(function(){
               resize();
                $("a.update-gallery-pic").click(function(e){ 
                  ...
                  var a = $(this);
                  $.ajax({
                      url : "<?php echo base_url(); ?>adminlevel/slideshow/status",
                      type : "POST",
                      dataType : "json",
                ...
                $("a.del-gallery-pic").click(function(e){
                  ...
                  var a = $(this);
                  $.ajax({
                      url : "<?php echo base_url(); ?>adminlevel/slideshow/delete",
                      type : "POST",
                      dataType : "json",
                      data: {status : a.attr('data'), id : a.attr('dataid')},
                      success : function(data){
