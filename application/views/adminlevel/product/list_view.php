           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  ...
                  var url = '<?php echo base_url(); ?>adminlevel/product/productactive?key='+key+"<?php echo ($home != "")? '&home=true' : ''; ?>";
...
$(document).ready(function(){
  ...
  {
    $.ajax({
      url: "<?php echo base_url('adminlevel/product/paggingactive'); ?>",
      type: "post",
      data: "page="+page+"<?php echo ($key != "")? '&key='.$key : ''; ?>"+"<?php echo ($home != "")? '&home=true' : ''; ?>",
