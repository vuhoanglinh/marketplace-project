      ...
      <div class="span12">
        <div class="box box-color box-bordered green">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('adminlevel/news/updateNews', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>            
            <div class="control-group">
              <label for="txtName" class="control-label">Tiêu đề</label>
                <div class="controls">
                  <input type="text" name="txtName" id="txtName" placeholder="Tiêu đề(*)" class="input-xxlarge" maxlength="255" value='<?php echo set_value('txtName', $name); ?>'>                  
                </div>                
            </div>
            <div class="control-group">
              ...
              <label for="slParent" class="control-label">Danh mục</label>
                <div class="controls">
                  ...
                  <?php
                    ...
                    {
                   ?>            
                    <option value="<?php echo $row->id; ?>" <?php if($id_category == $row->id) echo 'selected="selected"'; ?>><?php echo $row->name; ?></option>
                  <?php                    
                    }
                  ?>
                  </select>
            ...
            <div id="video" class="control-group" style="display:none;">
              <label for="txtVideo" class="control-label">Video</label>
                <div class="controls">
                  <input type="text" name="txtVideo" id="txtVideo" placeholder="Đường dẫn video" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtVideo', $video); ?>">               
                </div>                
            </div>
            <div id="extent">
            <div class="control-group">
              <label for="txtLink" class="control-label">Hình ảnh</label>
                <div class="controls">
                  <input type="text" name="txtLink" id="txtLink" placeholder="Đường dẫn hình ảnh" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtLink', $images); ?>">                  
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="txtKeyword" id="txtKeyword" rows="5" class="input-block-level" placeholder="Từ khóa"><?php echo set_value('txtKeyword', $keyword); ?></textarea>
              </div>
            </div> 
            <div class="control-group">
              <label for="txtDescription" class="control-label">Mô tả từ khóa</label>
              <div class="controls">
                <textarea name="txtDescription" id="txtDescription" rows="5" class="input-block-level" placeholder="Mô tả từ khóa"><?php echo set_value('txtDescription',$description); ?></textarea>
              </div>
            </div> 
            <div class="control-group">
              <label for="txtDetail" class="control-label">Mô tả bài viết</label>
              <div class="controls">
                <textarea name="txtDetail" id="txtDetail" rows="5" class="input-block-level" placeholder="Mô tả bài viết"><?php echo set_value('txtDetail',$detail); ?></textarea>
              </div>
            </div> 
            <div class="control-group">
              <label for="txtContent" class="control-label">Nội dung bài viết</label>
              <div class="controls">
                <textarea name="txtContent" id="txtContent" rows="5" class="input-block-level" placeholder="Nội dung bài biết"><?php echo set_value('txtContent',$content); ?></textarea>
              </div>
            </div> 
            <div class="control-group">
