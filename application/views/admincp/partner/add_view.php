      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/partner/addPartner', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            ...
            <div class="control-group">
              <label for="txtEmail" class="control-label">Email</label>
                <div class="controls">
                  <input type="text" name="txtEmail" id="txtEmail" placeholder="Nhập email (*)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtEmail', ''); ?>">                  
                </div>                
            </div>
            <div class="control-group">
              <label for="txtPhone" class="control-label">Số điện thoại</label>
                <div class="controls">
                  <input type="text" name="txtPhone" id="txtPhone" placeholder="Nhập số điện thoại (*)(Nhập số)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtPhone', ''); ?>">                  
                </div>                
            </div>
            <div class="control-group">
              <label for="txtLink" class="control-label">Liên kết</label>
                <div class="controls">
                  <input type="text" name="txtLink" id="txtLink" placeholder="Liên kết " class="input-xlarge" maxlength="255" value="<?php echo set_value('txtLink', ''); ?>">                  
                </div>                
            </div> 
            <div class="control-group">
              <label for="txtImages" class="control-label">Logo</label>
                <div class="controls">
                  <input type="text" name="txtImages" id="txtImages"  class="input-xlarge" placeholder="Logo" maxlength="255" value="<?php echo set_value('txtImages', ''); ?>">
            ...
            $(document).ready(function(){                               
              ...
              function checkcode()
              {
                ...
                { 
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/partner/checkcode",
                      data: "code="+code,
              ...
              function checkname()
              {
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/partner/checkname",
                      data: "name="+name,
                      success: function(msg){
                        if(msg == 1) {
                          $("#txtName").parent().parent().removeClass("success");
