                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo $row->link; ?>"><?php echo $row->link; ?></a></td>            	
                	  <td><img src="<?php echo base_url(); ?>public/<?php echo $row->logo; ?>" title="" alt="" width="100"></td>
                  ...
                  <script type="text/javascript">
                    $(document).ready(function(){
                      $("form#frmtrash a").click(function(){
                        ...
                        {
                          var url = '<?php echo base_url(); ?>admincp/partner/update?id='+a.attr('dataid');
                          $(location).attr('href',url);
                        }                
                        if(a.attr("action") == "del")
                        {                    
                            $.ajax({
                                url: '<?php echo base_url(); ?>admincp/partner/block',
                                type: "POST",
                                dataType: 'json',
                        ...
                        {
                          $.ajax({
                            url : "<?php echo base_url(); ?>admincp/partner/status",
                            type : "POST",
                            dataType : "json",
