  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url(); ?>admincp/user">User</a> <i class="icon-angle-right"></i> </li>
      ...
      <div class="span12">
        <div class="box box-color box-bordered green">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open_multipart('admincp/user/updateUser', array('id' => 'frmupdate', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            ...
            <div class="control-group">
              <label for="txtPhone" class="control-label">Chức vụ</label>
                <div class="controls">                  
                  <label class="radio">
            ...
            <div class="control-group">
              <label for="txtImages" class="control-label">Hình đại diện</label>
                <div class="controls">
                  <input type="text" name="txtImages" id="txtImages"  class="input-xlarge" placeholder="Hình đại diện" maxlength="255" value="<?php echo set_value('txttxtImages', ''); ?>">
