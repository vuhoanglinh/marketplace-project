        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>admincp/menu?key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"> <?php echo form_open("admincp/menu/movetrasha", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            <div class="dataTables_wrapper">     
              ...
              <div class="dataTables_length" style="display:none;">
                ...
                <a href="javascript:void(0)" action="add" class="btn btn-primary">
                  <i class="icon-plus"></i> Thêm mới</a>
                <a href="<?php echo base_url(); ?>admincp/menu/trash" class="btn btn-inverse"><i class="icon-trash"></i> Đã xóa</a>
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){  
                ...
                function loadmenu(page) {
                  $.ajax({
                      url: "<?php echo base_url('admincp/menu/pagging_menu'); ?>",
                      type: "post",
