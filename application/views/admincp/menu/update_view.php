      ...
      <div class="span12">
        <div class="box box-color box-bordered green">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/menu/updateMenu', array('id' => 'frmupdate', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
              ...
              <label for="slHaveChildren" class="control-label">Menu con</label>
                <div class="controls">
                  <select name="slHaveChildren" id="slHaveChildren" class="input-large">                
                    <option value="0" <?php echo ($havechildren == 0?'selected="selected"':''); ?>>Không</option>
                    <option value="1" <?php echo ($havechildren == 1?'selected="selected"':''); ?>>Có</option>
                  </select>
                </div>
            </div>
            -->
            ...
            <div class="control-group">
              <label for="txtLink" class="control-label">Link</label>
                <div class="controls">
                  <input type="text" name="txtLink" id="txtLink" placeholder="Link" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtLink', $link); ?>">                  
                </div>
            </div>
            <div class="control-group">
              <label for="txtSort" class="control-label">Sắp xếp</label>
                <div class="controls">
                  <input type="text" name="txtSort" id="txtSort" placeholder="Sort" class="input-large" maxlength="255" value="<?php echo set_value('txtSort', $sort); ?>">                  
                </div>
            </div>
            <div class="control-group">
            ...
            $(document).ready(function(){
              ...
              $("form#frmupdate").on('submit', function(){
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/menu/checkanothername",
                ...
                { 
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/menu/checkanothercode",
                      ...
                      $.ajax({
                          ...
                          success: function(data) {
                              ...
                              $("#modal-4 button.btn").click(function(){
                                if(data.status == 0)
                                {
                                  $(location).attr('href','<?php echo base_url(); ?>/admincp/menu');
                                }
                              });
                          }
                      });
