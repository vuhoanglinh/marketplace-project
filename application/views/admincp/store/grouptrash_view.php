  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url();?>admincp/store/trashg">Đã xóa</a></li>
      </ul>
        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>admincp/store/trashg?key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"><?php echo form_open("admincp/store/deleteg", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){
                function loadgroup(page) {
                  $.ajax({
                      url: "<?php echo base_url('admincp/store/pagginggrouptrash'); ?>",
                      type: "post",
                      ...
                      if($(this).attr("id") != "check_all") 
                      {
                        if($(this).is(":checked"))
                        {
                          var from = $("form#frmtrash");
                            ...
                            $.ajax({
                                url: "<?php echo base_url(); ?>admincp/store/outtrashg",
                                type: "POST",
                                data: 'id=' + $(this).val(),
                                success: function(data) {
                                  if(data.status == 1) {
