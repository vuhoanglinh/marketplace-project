                <?php foreach($query as $row)
                  ...
                  <tr>
                    ...
                    <td "hidden-350"><?php echo $row->detail;      ?></td> 
                  ...
                  $(document).ready(function(){
                    $("form#frmtrash a").click(function(){
                      ...
                      //{
                        //var url = '<?php echo base_url(); ?>admincp/store/updateg?id='+a.attr('dataid');
                      ...
                      if(a.attr("action") == "del")
                      {
                        if(confirm('Bạn có chắc chắn muốn xóa không? \nThao tác này sẽ xóa dữ liệu vĩnh viễn.') == true) {                
                          $.ajax({
                              url: '<?php echo base_url(); ?>admincp/store/deleteg',
                              type: "POST",
                              dataType: 'json',
                      ...
                      {
                        $.ajax({
                          url : "<?php echo base_url(); ?>admincp/store/statusg",
                          type : "POST",
                          dataType : "json",
