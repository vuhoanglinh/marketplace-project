      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/store/addStoreg', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            ...
            <div class="control-group">
              <label for="txtName" class="control-label">Tên</label>
                <div class="controls">
                  <input type="text" name="txtName" id="txtName" placeholder="Tên nhóm cửa hàng (*)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtName', ''); ?>">                  
                </div>                
            </div>     
            <div class="control-group">
            ...
            $(document).ready(function(){                               
              ...
              function checkcode()
              {
                ...
                { 
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/store/checkcodeg",
                      data: "code="+code,
              ...
              function checkname()
              {
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/store/checknameg",
                      data: "name="+name,
                      success: function(msg){
                        if(msg == 1) {
                          $("#txtName").parent().parent().removeClass("success");
