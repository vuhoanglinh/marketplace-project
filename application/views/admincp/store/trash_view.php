    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url();?>admincp/store">Cửa hàng</a> </li>
         <li> <a href="<?php echo base_url();?>admincp/store/trash">Đã xóa</a> </li>
      </ul>
        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>admincp/store/trash?id=<?php echo $id; ?>&key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"><?php echo form_open("admincp/store/delete", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            ...
            $(document).ready(function(){            
                function loadstore(page) {
                  $.ajax({
                      url: "<?php echo base_url('admincp/store/paggingtrash'); ?>",
                      type: "post",
                    ...
                    { 
                      if($(this).attr("id") != "check_all") 
                      {
                        if($(this).is(":checked"))
                        {
                          var from = $('form#frmtrash');
                            $.ajax({
                                url: "<?php echo base_url(); ?>admincp/store/outtrash",
                                type: "post",
                                dataType: 'json',
                                data: 'id=' + $(this).val(),
                                success: function(data) {
