      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/themes/addThemes', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>            
            <div class="control-group">
              <label for="txtName" class="control-label">Tên template</label>
                <div class="controls">
                  <input type="text" name="txtName" id="txtName" placeholder="Tên template (*)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtName', ''); ?>">                  
                </div>                
            </div>
            <div class="control-group">
              <label for="txtFolder" class="control-label">Tên thư mục</label>
                <div class="controls">
                  <input type="text" name="txtFolder" id="txtFolder" placeholder="Tên thư mục (*)" class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtFolder', ''); ?>">                  
                </div>
            </div>             
            <div class="control-group">
              <label for="txtImage1" class="control-label">Hình ảnh 1</label>
              <div class="controls">
                <input type="text" name="txtImage1" id="txtImage1"  class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtImage1', ''); ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="txtImage2" id="txtImage2"  class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtImage2', ''); ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="txtImage3" id="txtImage3"  class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtImage3', ''); ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="txtImage4" id="txtImage4"  class="input-xxlarge" maxlength="255" value="<?php echo set_value('txtImage4', ''); ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="txtDetail" id="txtDetail" rows="5" class="input-block-level" placeholder="Mô tả"><?php echo set_value('txtDetail',''); ?></textarea>
              </div>
            </div>       
