      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/email/addEmail', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>       
            <div class="control-group">
              <label for="txtName" class="control-label">Tên</label>
                <div class="controls">
                  <input type="text" name="txtName" id="txtName" placeholder="Nhập tên (*)" class="input-xlarge" maxlength="255" value="<?php echo set_value('txtName', ''); ?>">                  
                </div>                
            </div>    
            <div class="control-group">
            ...
            <div class="control-group">
              <label for="txtPassword" class="control-label">Mật khẩu</label>
                <div class="controls">
                  <input type="text" name="txtPassword" id="txtPassword" placeholder="Nhập mật khẩu (*)" class="input-xlarge" maxlength="255" value="<?php echo set_value('txtPassword', ''); ?>">                  
                </div>                
            </div>
            <div class="control-group">
              <label for="txtSMTP" class="control-label">SMTP Server</label>
                <div class="controls">
                  <input type="text" name="txtSMTP" id="txtSMTP" placeholder="Nhập smtp server (*)" class="input-xlarge" maxlength="255" value="<?php echo set_value('txtSMTP', ''); ?>">                  
                </div>
            </div>
            <div class="control-group">
              <label for="txtSSL" class="control-label">SMTP SSL</label>
                <div class="controls">
                  <input type="text" name="txtSSL" id="txtSSL" placeholder="Nhập smtp ssl" class="input-xlarge" maxlength="255" value="<?php echo set_value('txtSSL', ''); ?>">                  
                </div>
            </div>
            <div class="control-group">
              <label for="txtPort" class="control-label">SMTP Port</label>
                <div class="controls">
                  <input type="text" name="txtPort" id="txtPort" placeholder="Nhập smtp port (nhập số)" class="input-xlarge" maxlength="255" value="<?php echo set_value('txtPort', ''); ?>">                  
                </div>
            </div>  
            <div class="control-group">
            ...
            $(document).ready(function(){                               
              ...
              function checkemail()
              {
                ...
                { 
                  ...
                  else
                  {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>admincp/email/checkemail",
                        type: "POST",                        
                        data: "email="+email,
              ...
              function checkname()
              {
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      url: "<?php echo base_url(); ?>admincp/email/checkname",
                      type: "POST",                      
                      data: "name="+name,
                      success: function(msg){
                        if(msg == 1) {
