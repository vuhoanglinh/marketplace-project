      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/email/addEmailct', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>
            ...
            $(document).ready(function(){                               
              ...
              function checkcode()
              {
                ...
                { 
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/email/checkcodect",
                      data: "code="+code,
              ...
              function checkname()
              {
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/email/checknamect",
                      data: "name="+name,
                      success: function(msg){
                        if(msg == 1) {
                          $("#txtName").parent().parent().removeClass("success");
