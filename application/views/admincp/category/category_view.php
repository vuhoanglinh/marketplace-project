  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url();?>admincp/category">Danh mục sản phẩm</a> </li>
      </ul>
        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>admincp/category?key='+$('#search').val().trim();
          ...
          <div class="box-content nopadding"><?php echo form_open("admincp/category/block", array('id' => 'frmtrash', 'name' => 'frmtrash'));?>
            <div class="dataTables_wrapper">
              ...
              <div class="dataTables_length">  
                ...
                <a href="javascript:void(0)" action="add" class="btn btn-primary"> <i class="icon-plus"></i> Thêm mới</a> <a href="<?php echo base_url(); ?>admincp/category/trash" class="btn btn-inverse"><i class="icon-trash"></i> Đã xóa</a> <a id="btnAlert" style="display:none" href="#modal-4" role="button" class="btn" data-toggle="modal">Alert</a> 
              </div>              
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){
                function loadcategory(page) {
                  $.ajax({
                      url: "<?php echo base_url('admincp/category/pagging_category'); ?>",
                      type: "post",
