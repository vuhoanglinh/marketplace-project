...
<tr>
  ...
  <td><img src="<?php echo base_url(); ?>public/<?php echo $row->images; ?>" title="" alt="" width="100"></td>
  ...
  <td class="hidden-480"><a href="javascript:void(0)" action="update" dataid="<?php echo $row->id; ?>" class="btn" rel="tooltip" title="Chỉnh sửa"><i class="icon-edit"></i></a> <a href="javascript:void(0)" action="del" dataid="<?php echo $row->id; ?>" class="btn" rel="tooltip" title="Xóa"><i class="icon-remove"></i></a> <a href="<?php echo base_url('admincp/category/children'); ?>?id=<?php echo $row->id;?>" class="btn" rel="tooltip" title="Danh mục con"><i class="icon-list-alt"></i></a> <a href="<?php echo base_url('admincp/category/filter'); ?>?id=<?php echo $row->id;?>" class="btn" rel="tooltip" title="Bộ lọc"><i class="icon-filter"></i></a></td>
</tr>
...
$("form#frmtrash a").click(function(){
                  ...
                  {                    
                      $.ajax({
                          url: '<?php echo base_url(); ?>admincp/category/block',
                          type: "POST",
                          dataType: 'json',
                  ...
                  {
                      var url = '<?php echo base_url(); ?>admincp/category/add';
                      $(location).attr('href',url);
                  }
                });
});
