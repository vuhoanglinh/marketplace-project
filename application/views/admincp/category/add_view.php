      ...
      <div class="span12">
        <div class="box box-color box-bordered red">
          ...
          <div class="box-content nopadding"> 
            <?php echo form_open('admincp/category/addCategory', array('id' => 'frmadd', 'class' => 'form-horizontal form-bordered', 'novalidate' => 'novalidate')); ?>            
              ...
              <label for="slParent" class="control-label">Danh mục cha</label>
                <div class="controls">
                  ...
                  <?php
                    ...
                    {
                   ?>            
                    <option value="<?php echo $row->id; ?>" <?php if(isset($_GET['id']) && $_GET['id'] == $row->id) echo 'selected="selected"'; ?>><?php echo $row->name; ?></option>
                  <?php                    
                    }
                  ?>
                  </select>
            ...
            $(document).ready(function(){ 
              ...
              function checkname()
              {
                ...
                if(name == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/category/checkname",
                      data: "name="+name+"&id_parent="+parent,
              ...
              function checkTitle()
              {
                ...
                if(title == "")
                {
                  ...
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url(); ?>admincp/category/checktitle",
                      data: "title="+title+"&id_parent="+parent,
                      success: function(msg){
                        if(msg == 1) {
                          $("#txtNameSub").parent().parent().removeClass("success");
                          $("#txtNameSub").parent().parent().addClass("error");
