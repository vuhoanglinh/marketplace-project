  ...
  <div class="container-fluid">
    ...
    <div class="breadcrumbs">
      <ul>
        ...
        <li> <a href="<?php echo base_url();?>admincp/category/trash">Đã xóa</a> </li>
      </ul>
        ...
        <div class="box box-color box-bordered">
          ...
          $(document).ready(function(){ 
           ...
           $('#search').keypress(function(event){
              if(event.which == 13) {
                if($('#search').val() != ""){
                  var url = '<?php echo base_url(); ?>admincp/category/trash?key='+$('#search').val().trim();
            ...
            <script type="text/javascript">              
              ...
              $(document).ready(function(){
                function loadcategory(page) {
                  $.ajax({
                      url: "<?php echo base_url('admincp/category/paggingtrash_category'); ?>",
                      type: "post",
