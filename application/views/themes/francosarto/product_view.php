      ...
      <div class="col_left_block">
        ...
        <div class="left_block_content" id="left_cat">
          <ul>
            ...
            {
            ?>
                <li><a class="sub" href="<?php echo base_url('cua-hang')."/".$h_name."/san-pham"; ?>?rel=<?php echo $hr_rel;?>&c=<?php echo $row->id; ?>" tablink="#tab<?php echo $row->id; ?>"><?php echo $row->name; ?> (<?php echo $b_category['numpparent'][$b_count2]; ?>)</a></li>
            <?php 
                $b_count2++;
                } 
            ?>            
